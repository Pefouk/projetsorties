 ...
 */
final class Version20200224140513 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD etat_id INT DEFAULT NULL, ADD lieu_id INT NOT NULL, ADD organisateur_id INT NOT NULL, ADD campus_id INT DEFAULT NULL, DROP etat');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD etat VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP etat_id, DROP lieu_id, DROP organisateur_id, DROP campus_id');
    }
}
